...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref e78e48ea4e102fef7f379bc8f10afbfbf25633a6
  WORKING_DIRECTORY "/Users/jorijn/Development/docker-rippled-validator/.nih_c/unix_makefiles/AppleClang_10.0.0.10001145/src/libarchive"
...
if("${show_ref_output}" MATCHES "refs/remotes/e78e48ea4e102fef7f379bc8f10afbfbf25633a6")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "e78e48ea4e102fef7f379bc8f10afbfbf25633a6")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "e78e48ea4e102fef7f379bc8f10afbfbf25633a6")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 e78e48ea4e102fef7f379bc8f10afbfbf25633a6
  WORKING_DIRECTORY "/Users/jorijn/Development/docker-rippled-validator/.nih_c/unix_makefiles/AppleClang_10.0.0.10001145/src/libarchive"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/mellery451/libarchive.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/jorijn/Development/docker-rippled-validator/.nih_c/unix_makefiles/AppleClang_10.0.0.10001145/src/libarchive/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/jorijn/Development/docker-rippled-validator/.nih_c/unix_makefiles/AppleClang_10.0.0.10001145/src/libarchive/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/local/bin/git" checkout e78e48ea4e102fef7f379bc8f10afbfbf25633a6
      WORKING_DIRECTORY "/Users/jorijn/Development/docker-rippled-validator/.nih_c/unix_makefiles/AppleClang_10.0.0.10001145/src/libarchive"
      RESULT_VARIABLE error_code
      )
    if(error_code)
